// Shared with the Vite client via src/mail/search-query.js. Keep this file
// free of Node-only APIs so the production image and browser bundle can both
// import it. The runtime image copies /server, not /src.
